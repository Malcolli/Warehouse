...
const CONTROLLERS = "controllers";  //name of the folder for controllers
...
class Dispatcher {
    ...
    public static function dispatch() {
        ...
        $base_array = explode('\\', __NAMESPACE__);
        $base_namespace = $base_array[0];
        ...
        //prepend namespaces
        $controllerName = "\\" . $base_namespace . "\\" . CONTROLLERS . "\\" . $controllerName;
